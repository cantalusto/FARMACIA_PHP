...
<head>
    ...
    <title>Editar Cliente - Farmácia Pague Mais</title>
            ...
            <div class="form-card">
                <form method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="cpf" name="cpf" value="<?= htmlspecialchars($cliente['cpf']) ?>" maxlength="14" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="telefone" name="telefone" value="<?= htmlspecialchars($cliente['telefone']) ?>" maxlength="15" required>
                    </div>
