...
if ($id && $confirmado && $id != $_SESSION['admin_id']) {
...
// Redirecionar se ID inválido ou tentativa de auto-exclusão
...
<head>
    ...
    <title>Excluir Usuário - Farmácia Pague Mais</title>
        ...
        <div class="delete-body">
            <?php if ($usuario): ?>
                <div class="user-card">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <small class="text-muted">Usuário a ser excluído</small>
                            <h4 class="mb-0"><?= htmlspecialchars($usuario['usuario']) ?></h4>
                        </div>
                        <div>
                ...
                <div class="warning-message">
                    ...
                    <p class="mb-0">Esta ação é irreversível. Todos os dados associados a este usuário serão permanentemente removidos do sistema.</p>
                </div>
            ...
            <?php else: ?>
                <div class="alert alert-danger">
                    <i class="fas fa-exclamation-circle me-2"></i> Usuário não encontrado
                </div>
