...
<head>
    ...
    <title>Adicionar Usuário - Farmácia Pague Mais</title>
    ...
    <div class="admin-panel">
        <div class="admin-header">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h1 class="h4 mb-0">Adicionar Novo Usuário</h1>
            ...
            <div class="form-card">
                <form method="POST">
                    <div class="mb-4">
                        ...
                        <div class="form-text">Digite o nome de usuário para acesso ao sistema</div>
                    </div>
