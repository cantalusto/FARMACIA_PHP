...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <h1 class="h3 mb-1">Farmácia Pague Mais</h1>
            <p class="mb-0">Sistema Administrativo</p>
        </div>
        
        <div class="login-body">
            <form method="POST">
                <h2 class="h5 mb-4 text-center" style="color: var(--primary-color);">Acesso Restrito</h2>
                ...
                <button class="w-100 btn btn-lg btn-login text-white mb-3" type="submit">
                    <i class="fas fa-sign-in-alt me-2"></i> Entrar
                </button>
                
                <p class="footer-text text-center mt-4">
                    &copy; 2025 Farmácia Pague Mais <span class="mx-2">•</span> Todos os direitos reservados
                </p>
            </form>
        </div>
    </div>
