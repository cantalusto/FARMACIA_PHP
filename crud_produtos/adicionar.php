...
<head>
    ...
    <title>Adicionar Produto - Farmácia Pague Mais</title>
    ...
    <div class="product-panel">
        <div class="product-header">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h1 class="h4 mb-0">Adicionar Novo Produto</h1>
            ...
            <div class="form-card">
                <form method="POST">
                    <div class="mb-4">
                        ...
                        <div class="form-text">Digite o nome comercial do medicamento</div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">Informe o laboratório farmacêutico</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-text">Preço unitário do produto</div>
                        </div>
